#pragma once
// AXS15231B driver for the Guition JC3248W535C (320x480), for GFX 1.4.9 on arduino v2.
// GFX 1.4.9 has no 320x480 init and its constructor takes no init_operations, so this
// subclass overrides tftInit() with the OFFICIAL 320x480 type2 init sequence copied
// verbatim from Arduino_GFX v1.6.7 (axs15231b_320480_type2_init_operations). COLMOD is
// forced to 0x55 (RGB565) separately in DisplayUI::begin() after this init.
